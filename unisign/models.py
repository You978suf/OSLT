...
class Uni_Sign(nn.Module):
    def __init__(self, args):
        ...
        # Avoid HF safetensors auto-conversion API calls that may fail on restricted networks.
        self.mt5_model = MT5ForConditionalGeneration.from_pretrained(mt5_path, use_safetensors=False)
        self.mt5_tokenizer = T5Tokenizer.from_pretrained(mt5_path)
