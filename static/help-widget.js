...
(function () {
  ...
  var css = ''
    ...
    + '.hw-close{background:none;border:none;font-size:20px;cursor:pointer;color:#56627a;line-height:1;padding:6px 8px;margin:-6px -4px -6px 0;border-radius:8px;}'
    + '.hw-close:hover{background:#eef2f8;color:#0d1726;}'
